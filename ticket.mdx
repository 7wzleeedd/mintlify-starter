...
<Accordion title="whats working for now" icon="chair-office">
  ...
  - managing tickets staff members with the bojo ticket helper or bojo ticket admin roles (or administrator permissions) can interact with tickets. the system is designed to be intuitive, allowing your team to focus on providing support.
</Accordion>