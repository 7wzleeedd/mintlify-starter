...
<Steps>
  <Step title="bot perms">
    <p>before adding miko to your server, ensure you have the following permissions:<p>
  
    Administrator permission or equivalent permissions
    Bot role must be in the top 5 roles of your server
    Manage Channels permission for voice features
    Manage Roles permission for moderation features
  </Step>
  <Step title="add miko to your Server">
    <p>
  ...
  <Step title="basic setup">
    ...
    <CodeGroup>
    ```bash
    ,setup    Creates a jail channel, log channel, and jail role for moderation
    ```
    </CodeGroup>
  </Step>
