...
<Steps>
  ...
  <Step title="add miko to tour Server">
    <p>click [here](https://discord.com/oauth2/authorize?client_id=1401154387371622420) to add miko to your server</p>
  </Step>

  <Step title="basic setup">
    <p>after adding miko, run these essential setup commands:</p>
    <CodeGroup>
